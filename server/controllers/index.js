...
const setCatName = async (req, res) => {
  ...
  */
  ...
  /* After our await has resolved, and if no errors have occured during the await, we will end
     up here. We will update our lastCatAdded cat to the one we just added. We will then send that
...
const updateLast = (req, res) => {
  ...
  /* Remember that lastCatAdded is a Mongoose document (made on line 14 if no new
     ...
     Since lastCatAdded is likely already in the database, .save() will update it rather
     than make a new cat.
